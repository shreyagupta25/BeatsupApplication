...
public class ArtistReg {
	...
	public ArtistReg(String email, String password, String fname, String lname, String answer, String contact,
			int securityid, int areaid, int skillid) {
		super();
		this.email = email;
